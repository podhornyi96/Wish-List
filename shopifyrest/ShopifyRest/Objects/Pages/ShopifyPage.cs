...
namespace ShopifyRest.Objects.Pages
{
    /// <summary>
    /// An entity representing a Shopify product.
    /// </summary>
    [ShopifyRootObject("page")]
    public class ShopifyPage : ShopifyObject, IShopifyBaseObject
    {
        /// <summary>
        ...
        public IEnumerable<ShopifyMetaField> Metafields { get; set; } = new List<ShopifyMetaField>();
