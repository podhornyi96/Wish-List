...
using RestSharp;
using ShopifyRest.Objects.Authorize;
using ShopifyRest.Objects.Common;
//using ShopifyRest.Objects.Engines;
...
{
    public class ShopifyAuthorizationService : ShopifyBaseService
    {
        ...
        public static bool IsAuthenticWebhook(NameValueCollection requestHeaders, Stream inputStream, string shopifySecretKey)
        {
        ...
        public static bool IsValidMyShopifyUrl(string url)
        {
            return Net.HasShopifyHeader(url);
        }
        ...
        public static Uri BuildAuthorizationUrl(IEnumerable<ShopifyAuthorizationScope> scopes, string myShopifyUrl, string shopifyApiKey, string redirectUrl = null, string state = null)
        {
            ...
            UriBuilder builder = new UriBuilder(BuildShopUri(myShopifyUrl));
        ...
        public string Authorize(string code, string shopifyApiKey, string shopifySecretKey)
        {
            var resp = Post<AuthorizeResponse, AuthorizeRequest>("/admin/oauth/access_token", new AuthorizeRequest()
            {
                Code = code,
